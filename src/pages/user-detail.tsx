...
import { ArrowLeft, User, Mail, Phone, Globe, MapPin, Building } from "lucide-react"
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="text-center py-12">
          <p className="text-destructive text-lg font-medium">Error loading user</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <CardContent className="space-y-4">
            <div className="space-y-3">
              <div>
                ...
                <p className="text-base">{user.address.street}, {user.address.suite}</p>
              </div>
        ...
        <Card className="lg:col-span-2">
          <CardHeader>
            ...
            <CardDescription>Professional and company information</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div>
                <p className="text-sm font-medium text-muted-foreground">Catch Phrase</p>
